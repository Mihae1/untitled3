...
public class cto15text {
    public static void main(String[] args) {
        ...
        //Aufgabe 1 wie viele chars gibt es
        int x = text.length();
        System.out.println("There are " + x + " characters in the text ! ");


        int counter = 0;
        for (int chars = 0; chars < text.length(); chars++) {
            if (Character.isLetter(text.charAt(chars))) {
                counter++;

            }
        }
        System.out.println("There are "+counter+" letters in the text ! ");

        String[] words = text.split( " ");
        //int num =new String[]{words[words.length]}
        int o= 0;
